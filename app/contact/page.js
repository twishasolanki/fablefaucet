  ...
  return (
    <Layout>
      <div >
        ...
        <div className="flex md:flex-row flex-col content" htmlFor="reload">
          <div className="md:w-1/2 flex flex-col mx-auto justify-center items-center ">
            <p className='text-4xl font-bold ms-12 md:mt-0 mt-10'>Contact Info</p>
            <p className='text-2xl font-bold mt-7'>Our Location:</p>
            <div className='flex justify-end items-end mx-auto'>
              <button type='button' className='bg-black rounded-full w-14 h-14 mb-4'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" className="bi bi-geo-alt-fill ms-4" viewBox="0 0 16 16">
                <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6" />
              </svg></button>
              <p className='text-md w-1/2 mt-1 mx-20'>Balaji Plumbing Systems Plot No. 15, Rani Industrial Area-2, Behind Parin Furniture, Nr. NH-8, Gondal Road, Vavdi-17 Rajkot-360004</p>
            </div>
            <p className='text-2xl font-bold mt-10'>Call for help:</p>
            <div className='flex mr-20'>
              ...
              <p className='text-md mx-20 '>+91-9327471604</p>
            </div>
            <p className='text-2xl ms-28 font-bold mt-7'>Mail us for information</p>
            <div className='flex mr-20'>
              ...
              <p className='text-md mx-20'>fablefaucet@gmail.com</p>
            </div>
          </div>
          <div className="md:w-1/2 md:ms-12 ">
